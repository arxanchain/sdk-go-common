...
type RegisterWalletBody struct {
	Id        commdid.Identifier `json:"id,omitempty"`         //Optional, if empty, generated by wallet service
	Type      commdid.DidType    `json:"type,omitempty"`       //Wallet Type: 1. "Organization"; 2. "Dependent"; 3. "Independent"; 4. "Asset"
	...
	Metadata  interface{}        `json:"meta_data,omitempty"`  //Register user metadata
...
type RegisterSubWalletBody struct {
	...
	Type      commdid.DidType    `json:"type,omitempty"`       //Wallet Type: 1."cash"; 2."fee"; 3."loan"; 4."interest"
	PublicKey *ed25519.PublicKey `json:"public_key,omitempty"` //User public key. Optional, if empty, keypaire auto generated by wallet service
}
...
type AssetBalance struct {
	...
	Status int    `json:"status,omitempty"` //asset status
}
...
type WalletInfo struct {
	Id       commdid.Identifier                 `json:"id,omitempty"`
	Type     commdid.DidType                    `json:"type,omitempty"`
