...
type RegisterWalletBody struct {
	Id        commdid.Identifier `json:"id"`         //Optional, if empty, generated by wallet service
	Type      commdid.DidType    `json:"type"`       //Wallet Type: 1. "Organization"; 2. "Dependent"; 3. "Independent"; 4. "Asset"
...
type RegisterSubWalletBody struct {
	Id        commdid.Identifier `json:"id"`         //main wallet id
	Type      commdid.DidType    `json:"type"`       //Wallet Type: 1."cash"; 2."fee"; 3."loan"; 4."interest"
	PublicKey *ed25519.PublicKey `json:"public_key"` //User public key. Optional, if empty, keypaire auto generated by wallet service
}
...
type WalletRequest struct {
	...
	Signature *pki.SignatureBody `json:"signature"`
}
...
type WalletInfo struct {
	Id       commdid.Identifier                 `json:"id"`
	Type     commdid.DidType                    `json:"type"`
	Endpoint commdid.DidEndpoint                `json:"endpoint"`
	Status   commdid.DidStatus                  `json:"status"`
	Created  int64                              `json:"created"`
	Updated  int64                              `json:"updated"`
	HDS      map[commdid.Identifier]*WalletInfo `json:"hds"`
}
...
type POEBody struct {
	...
	ParentId   commdid.Identifier `json:"parent_id"`
	Owner      commdid.Identifier `json:"owner"`
